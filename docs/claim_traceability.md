...
|----|--------|----------|--------|
| T1 | `outputs/tables/smoke_test_results.csv` matches pin in `config/expected_outputs.json` | `python scripts/validate_outputs.py` → `VALIDATION PASSED` after `python reproduce_all.py` at `5032561896094242bd6e4b7384377e2bcb397c83` (2026-04-12) | **VERIFIED** |
...
| G1 | Portfolio `eaa_system/system_snapshot.json` binds `repos.shared-core.commit` to this repo HEAD | Portfolio snapshot reconciled 2026-04-12: `repos.shared-core.commit` = `5032561896094242bd6e4b7384377e2bcb397c83`; matches authoritative shared-core pin | **VERIFIED** |
